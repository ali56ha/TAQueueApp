...
/**
 * NOTE: this class was not one that I (Sarah Hong) wrote. It is from an open source github that
 * performs the deletions based on a swipe gesture. The repo can be viewed here:
